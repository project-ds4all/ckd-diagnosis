...
class CKDAnalyzer:
    ...
    def diet_assigner(patient: PatientRequest):
        ...
        if patient.probability > 0.6:
            ...
            patient.vegetables = "Procurar consumir verduras al vapor. En la preparación de ensaladas evitar aderezos como vinagreta y salsas, en su lugar acompañar con aceite de oliva"
            patient.sugars = "Evitar el consumo de postres, gaseosas y jugos."
            patient.fruits = "Evitar el consumo de jugos, en su lugar consumir una porción de fruta."
            ...
            patient.dairy = "Evitar el consumo de quesos. Procurar el consumo de leche descremada y productos bajos en grasa."
            ...
            patient.fruits = "Procurar consumir fruta al menos una vez al día."
            ...
            patient.dairy = "Procurar el consumo de leche descremada y productos bajos en grasa."
            patient.alcohol = "Evitar el consumo de cualquier tipo de bebidas alcohólicas."
        else:
            patient.meal = "Evitar excesos en alimentos procesados como galletas."
            patient.vegetables = "Procurar acompañar el almuerzo con una ensalada."
            ...
            patient.dairy = "Mantener un consumo controlado de lácteos."
